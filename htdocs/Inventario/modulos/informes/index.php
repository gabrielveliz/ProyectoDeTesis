...
<script src="Highcharts-6.0.3/code/highcharts.js"></script>
<script src="Highcharts-6.0.3/code/modules/exporting.js"></script>
 
        <div>
          <img id="lo" src="../../img/logo.png">
       </div>
    <div id="bienvenida">
<span><p>Informes</p></span>
    </div>
    </head>
    <body>
    <br/><br/> 
    <div id="listas">
        <table id="menu" width="100%" align="center">
            <tr>
                ...
                <th><a href="excel.php">Exportacion Excel</a></th>
                <th><a href="word.php">Exportacion Word</a></th>
                <th><a href="pdf.php" target="_blank">Exportacion PDF</a></th>
...
<tr>
    <th></th>
        ...
        <table id="lista" width="100%" align="center">
        <td><p>El presente informe tiene como objetivo mostrar la gestion dentro del departamento de ligistica y entregar informacion que permita apoyar a la toma de decisiones de la empresa Muebles Veliz.</p></td>
    </table>
